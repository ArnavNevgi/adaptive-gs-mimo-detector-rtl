# Phase 9 ZedBoard PL-only UART demo implementation flow.
# Target: ZedBoard Zynq-7000, xc7z020clg484-1
# Top: zedboard_mimo_uart_top

set script_dir [file dirname [file normalize [info script]]]
set repo_root [file normalize [file join $script_dir ".."]]
set output_root [file join $repo_root "results" "phase9_zedboard_uart"]
set build_root [file join $repo_root "build" "vivado_impl_zedboard_uart_demo"]

set default_part_name xc7z020clg484-1
set top_name zedboard_mimo_uart_top
...
set empty_include_dir [file join $build_root "_empty_include"]

file mkdir $output_dir
file mkdir $build_dir
file mkdir $empty_include_dir

set empty_fixed_point_pkg [file join $empty_include_dir "fixed_point_pkg.sv"]
set empty_pkg_fp [open $empty_fixed_point_pkg w]
puts $empty_pkg_fp ""
close $empty_pkg_fp
...
puts "Phase 9 ZedBoard UART demo Vivado implementation"
...
create_project -force adaptive_gs_mimo_detector_zedboard_uart_demo $build_dir -part $part_name
...
set uart_demo_files [list \
    rtl_seq/uart_rx.sv \
    rtl_seq/uart_tx.sv \
    rtl_seq/uart_mimo_protocol.sv \
    rtl_seq/zedboard_mimo_uart_top.sv \
]
set board_xdc_file [file normalize [file join $repo_root "constraints" "zedboard_uart_demo.xdc"]]

puts "Reading sequential RTL files:"
foreach rtl_file [concat $rtl_seq_files $uart_demo_files] {
...
if {![file exists $board_xdc_file]} {
    error "Missing ZedBoard UART constraints file: $board_xdc_file"
}
...
write_checkpoint -force [file join $output_dir "routed_zedboard_uart_demo.dcp"]

set bitstream_path [file join $output_dir "zedboard_mimo_uart_top.bit"]
...
puts "ZedBoard UART demo implementation reports written to: $output_dir"
